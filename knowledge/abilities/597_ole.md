...
Ole makes this Pokemon naturally evasive, reducing the accuracy of all single-target moves by 20%. Named after the bullfighting dodge, it turns every incoming attack into a gamble - 100% accurate moves drop to 80%, while less reliable moves become even more frustrating.
