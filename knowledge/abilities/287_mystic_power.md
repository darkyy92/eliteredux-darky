...
- **No Type Requirement**: Moves don't need to match the Pokémon's type(s) to gain STAB
...
- Applies to all damaging moves used by the Pokémon with this ability
...
#### Positive Synergies
- **Life Orb**: 1.5x (Mystic Power) × 1.3x (Life Orb) = 1.95x total multiplier
...
- **Adaptability**: If a Pokémon somehow had both, normal STAB moves would get 2x × 1.5x = 3x total
...
- With Mystic Power: 80 × 1.5 = 120 effective BP

**Base 100 Power Move** (e.g., Earthquake):
- Without Mystic Power: 100 BP  
- With Mystic Power: 100 × 1.5 = 150 effective BP

**Comparison to Normal STAB**:
- Normal STAB move: 80 BP × 1.5 = 120 BP
- Mystic Power non-STAB: 80 BP × 1.5 = 120 BP
- **Result**: Every move hits as hard as a STAB move would normally

### Common Users in Elite Redux
Based on the species data, Mystic Power appears on:
- **Psychic-types**: Abra line, Ralts line, and other psychic Pokémon
- **Legendary/Mythical Pokémon**: Various legendary species as regular or innate ability
- **Mixed Attackers**: Pokémon with balanced offensive stats
- **Utility Pokémon**: Species that benefit from universal damage enhancement
...
#### Direct Counters
- **High Defensive Stats**: Pokémon with excellent bulk can still tank enhanced moves
...
- **Niche**: Allows Pokémon to use their entire movepool effectively
