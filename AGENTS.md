...
- When you learn new stuff, especially when you had to search a lot to understand how something works and is connected, don't hesitate to write into AGENTS.md so next time it will be much faster > like training the AI so it gets better and better!
...
- Update AGENTS.md with quick references that link to these detailed guides
